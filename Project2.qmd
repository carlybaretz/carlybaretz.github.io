...
```
Next I made a bar plot to visualize the amount of Netlfix titles with the given pattern. 
...
```
Finally, I made a bar plot to visualize the distribution of years mentioned in Netflix titles. 

the spread of Netflix titles containing years, and the amount of titles with names a year. 
```{r}
